    ...
    Bootstrap.prototype = {
        ...
        */
        ...
        _createApplication: function (content) {
            ...
            var width = window.innerWidth * dips;
            var height = window.innerHeight * dips;

            this.application.setCanvasResolution(this.appProperties['resolution_mode'], width, height);
            this.application.setCanvasFillMode(this.appProperties['fill_mode'], width, height);
        ...
        _createCanvas: function () {
            ...
            var dips = window.devicePixelRatio;
            this.canvas.width = window.innerWidth * dips;
            this.canvas.height = window.innerHeight * dips;
